...
[![GitHub Stars](https://img.shields.io/github/stars/coti-io/coti-history-node.svg)](https://github.com/coti-io/coti-history-node/stargazers)
[![GitHub Issues](https://img.shields.io/github/issues/coti-io/coti-history-node.svg)](https://github.com/coti-io/coti-history-node/issues)
[![Current Version](https://img.shields.io/badge/version-1.5.0.RELEASE-green.svg)](https://github.com/coti-io/coti-history-node/)
...
java -jar historynode/target/historynode-1.5.0.RELEASE.jar --spring.config.additional-location=historynode.properties
```
#### Docker container
